...
- `source/pey_man/trainWorkoutModelDemo.m` - trains the Strava-based workout speed model and generates a treadmill-style plan.
...
This branch adds a Strava/Fitbit training prototype for personalized running plans. Kaggle data is kept local and ignored by Git. Setup and run notes are in `WORKOUT_MODEL_TRAINING.md`.
