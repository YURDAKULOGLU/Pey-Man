...
if activeMinutes <= 0
    ...
    dominantMinutes = caloriesByActivity.minutes(caloriesByActivity.activity == "sit");
    dominantCalories = caloriesByActivity.calories(caloriesByActivity.activity == "sit");
else
    ...
    walkMinutes = activeRows.minutes(activeRows.activity == "walk");
    runMinutes = activeRows.minutes(activeRows.activity == "run");
    if isempty(walkMinutes)
        walkMinutes = 0;
    end
